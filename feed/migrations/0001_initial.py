...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('offer', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='feed.Offer')),
                ('request_as_response', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='feed.Request')),
            ],
        ),
        migrations.CreateModel(
            name='RespondRequest',
